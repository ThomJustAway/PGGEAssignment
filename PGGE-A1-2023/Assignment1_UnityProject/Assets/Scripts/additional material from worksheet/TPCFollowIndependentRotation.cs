...
namespace PGGE
{
    public class TPCFollowIndependentRotation : TPCBase
    {
        ...
        //if it is on android, include the touch field
        #if UNITY_ANDROID
        ...
        public override void Update()
        {
            ...
            Vector3 forward1 = mCameraTransform.forward;
            Vector3 right2 = mCameraTransform.right;
            Vector3 up3 = mCameraTransform.up;

            //find the desired offset of the position
